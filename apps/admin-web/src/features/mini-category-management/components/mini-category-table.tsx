                    ...
                    <TableCell>
                      <div className="flex justify-end items-center gap-1.5 pr-4">
                        ...
                        <Button
                          ...
                          aria-label="Delete"
                          title={item.status === "ACTIVE" ? "Inactivate first" : "Delete"}
                          onClick={async () => {
                            if (isBusy) return;
...
{totalPages > 1 && (
  <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-5 py-4">
    <span className="text-xs font-medium text-gray-500">
      ...
      {filteredData.length} Mini Categories
    </span>
    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-700 shadow-sm transition-all duration-200 hover:border-teal-600 hover:bg-teal-600 hover:text-white disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40"
      >
        <ChevronLeft
          size={18}
          strokeWidth={2.5}
