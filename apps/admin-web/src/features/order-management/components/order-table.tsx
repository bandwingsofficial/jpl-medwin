        ...
        <div className="min-w-[1000px]">
          ...
          <div
            className="
              ...
              z-10
              hidden
              grid-cols-[1.1fr_1.1fr_1.1fr_0.9fr_0.9fr_0.8fr_0.7fr_1fr]
              items-center
              border-b
              border-gray-200
              bg-gray-50/75
          ...
          <div className="divide-y divide-gray-100">
            {paginatedOrders.map((order) => {
              ...
              const createdDateObj = order.createdAt ? new Date(order.createdAt) : null;
              const hasValidCreatedDate = createdDateObj && !isNaN(createdDateObj.getTime());
                  ...
                  <div className="min-w-0">
                    {hasValidCreatedDate ? (
                      <div>
                        ...
                        <p className="whitespace-nowrap text-[10px] text-gray-400 font-normal">
                          {createdDateObj.toLocaleTimeString("en-IN", {
                            hour: "2-digit",
                            minute: "2-digit",
                            hour12: true,
                          })}
