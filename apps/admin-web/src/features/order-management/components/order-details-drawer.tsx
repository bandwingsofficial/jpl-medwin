...
export default function OrderDetailsDrawer({
  ...
  */
      ...
      <div className="flex justify-between">
        ...
        <span>
          ...
          <div className="space-y-4">
            ...
            {order.status === "CANCELLED" && (order.cancellationReason || order.cancellation?.reason || (order.metadata as any)?.cancellationReason) && (
              <div className="rounded-xl border border-red-200 bg-red-50/70 p-4 shadow-sm">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="mt-1 rounded-lg border border-red-200 bg-white p-3 text-sm font-medium text-gray-900 shadow-sm">
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-1 text-xs text-red-800">
                    {(order.cancelledAt || order.cancellation?.cancelledAt) && (
                      <p>
  ...
  {(order.gstNumber || order.notes?.gstNumber) && (
    <div className="mt-2 rounded-lg border border-teal-100 bg-teal-50 px-2.5 py-1.5">
      <p className="text-[10px] font-bold uppercase tracking-wider text-teal-800">
        GST Number
      </p>
      <p className="font-mono text-xs font-bold text-teal-950">
        {order.gstNumber || order.notes?.gstNumber}
      </p>
    </div>
  )}
...
{order.notes?.customerNote && (
  ...
  {Number(order.totals?.overweightDeliveryCharge || 0) > 0 && (
    <div className="flex items-center justify-between">
      <span className="text-gray-500">
      ...
      <span className="font-medium text-amber-700">
        +₹
        {Number(
          order.totals?.overweightDeliveryCharge || 0
        ).toFixed(2)}
      </span>
    </div>
  )}
