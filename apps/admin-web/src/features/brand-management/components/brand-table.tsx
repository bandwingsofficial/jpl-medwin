  ...
  <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-5 py-4">
    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-300 bg-white shadow-sm transition-all duration-200 text-gray-700 hover:bg-teal-600 hover:border-teal-600 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:border-gray-300 disabled:hover:text-gray-400"
      >
        <ChevronLeft
          size={18}
          strokeWidth={2.5}
