            ...
            (collection) => (
              ...
              >
                <td className="px-5 py-3">
                  <span className="inline-flex items-center justify-center min-w-[28px] h-7 px-2 rounded-md text-xs font-bold bg-teal-50 text-teal-700 border border-teal-100">
                    #{collection.order}
                  </span>
                </td>
