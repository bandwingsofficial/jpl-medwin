...
import { CategoryS3ImageResolverService } from './application/services/category-s3-image-resolver.service';
import { SubCategoryS3ImageResolverService } from './application/services/sub-category-s3-image-resolver.service';
import { MiniCategoryS3ImageResolverService } from './application/services/mini-category-s3-image-resolver.service';
...
@Module({
  ...
  providers: [
    ...
    CategoryS3ImageResolverService,
SubCategoryS3ImageResolverService,
MiniCategoryS3ImageResolverService,
 ...
 exports: [
  // Repository Tokens
  TOKENS.CATEGORY_REPO,
  TOKENS.SUB_CATEGORY_REPO,
  TOKENS.MINI_CATEGORY_REPO,
