...
describe('OrderAddressSnapshotMapper', () => {
  ...
  it('parses versioned snapshot JSON', () => {
    ...
    expect(snapshot && 'version' in snapshot ? snapshot.version : undefined).toBe(1);
    expect(snapshot && 'capturedAt' in snapshot ? snapshot.capturedAt : undefined).toBe('2024-06-16T12:00:00.000Z');
