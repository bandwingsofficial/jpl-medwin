...
export class CancelOrderUseCase {
  ...
  async execute(input: {
    ...
    order.cancel(trimmedReason, 'Customer');
   ...
   */
    ...
    return {
      ...
      data: {
        ...
        cancellationReason: updated.cancellationReason ?? trimmedReason,

        cancelledBy: updated.cancelledBy ?? 'Customer',

        cancellation: {
          cancelledAt: updated.cancelledAt,
          reason: updated.cancellationReason ?? trimmedReason,
          cancelledBy: updated.cancelledBy ?? 'Customer',
        },
        ...
        totals: {
          ...
          overweightDeliveryCharge: updated.overweightDeliveryCharge,
