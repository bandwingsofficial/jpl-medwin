...
import {
  CalculateGuestCartSummaryUseCase,
  GuestCartItemInput,
} from '../../application/use-cases/calculate-guest-cart-summary.use-case';
...
export class CartController {
  constructor(
    ...
    private readonly calculateGuestCartSummaryUseCase: CalculateGuestCartSummaryUseCase,
  ) {}

  // =======================
  // 🧮 CALCULATE GUEST CART SUMMARY (PUBLIC)
  // =======================
  ...
  async calculateGuestSummary(
    ...
    const data = await this.calculateGuestCartSummaryUseCase.execute({
      items: body.items,
    });

    return {
      message: 'Guest cart summary calculated successfully',
