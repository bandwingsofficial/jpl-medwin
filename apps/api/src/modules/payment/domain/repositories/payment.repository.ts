...
export abstract class PaymentRepository {
  ...
  abstract create(payment: Payment, tx?: any): Promise<Payment>;

  // =======================
  // 💾 UPDATE
  // =======================

  abstract update(payment: Payment, tx?: any): Promise<Payment>;
  ...
  abstract findByCheckoutSessionId(checkoutSessionId: string): Promise<Payment[]>;
