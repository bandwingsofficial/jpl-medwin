    ...
    return {
      ...
      profile: user.profile
        ? {
            ...
            customerType: user.profile.customerType ?? undefined,

            clinicHospitalName: user.profile.clinicHospitalName ?? undefined,

            whatsappNumber: user.profile.whatsappNumber ?? undefined,

            gstNumber: user.profile.gstNumber ?? undefined,
