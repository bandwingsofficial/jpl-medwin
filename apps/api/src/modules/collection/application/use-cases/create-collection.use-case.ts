...
export class CreateCollectionUseCase {
  ...
  async execute(input: {
    ...
    if (deletedCollection) {
      ...
      const restored = await this.collectionRepo.updateWithOrder(deletedCollection, input.order);
    ...
    const created = await this.collectionRepo.createWithOrder(collection, input.order);
