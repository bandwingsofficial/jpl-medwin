...
import { AdminCheckoutController } from './presentation/controllers/admin-checkout.controller';
...
@Module({
  ...
  controllers: [CheckoutSessionController, AdminCheckoutController],
  ...
  providers: [
    ...
    GetAdminAbandonedCheckoutsUseCase,
    GetAdminAbandonedCheckoutByIdUseCase,
  ],
