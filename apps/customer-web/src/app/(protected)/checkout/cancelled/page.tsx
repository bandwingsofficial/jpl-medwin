    ...
    <div className="mx-auto flex min-h-[80vh] w-full max-w-3xl items-center justify-center px-4 pt-4 pb-10 md:py-10 select-none">
      ...
      <div className="w-full rounded-3xl bg-white p-8 md:p-12 text-center border border-gray-100 shadow-sm flex flex-col items-center">
        ...
        <div className="mt-8 flex flex-col w-full sm:w-auto gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href={orderId ? `/checkout/payment?orderId=${orderId}` : "/checkout"}
          ...
          >
            ...
            <span>{orderId ? "Retry Payment" : "Return to Checkout"}</span>
          </Link>

          {/* VIEW CURRENT ORDER LOG FILES */}
          <Link
            href={orderId ? "/account/orders" : "/cart"}
          ...
          >
            ...
            <span>{orderId ? "View Orders" : "View Cart"}</span>
          </Link>
        </div>
