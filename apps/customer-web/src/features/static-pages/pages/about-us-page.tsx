...
const team = [
  ...
  { initials: "MK", name: "Mr. Markandaiah", role: "Director", color: "#115E59" },
...
.reveal-active {
  ...
  line-height: 1;
        ...
        /* ── Values Grid: 3 per row on desktop ── */
        .values-grid {
          display: grid;
        ...
        /* ─────────────────────────────────────────────
           FIX: Mobile-first breakpoints.
           768px = tablets/large phones, 480px = small phones.
        ───────────────────────────────────────────── */
        @media (max-width: 768px) {
          ...
          .cert-item { padding: 0 18px; }
        }

        @media (max-width: 480px) {
          .value-card-num { display: none; }
          .team-avatar { width: 56px; height: 56px; font-size: 17px; }
          .mv-block::before { display: none; }
        }
          ...
          <div style={{ maxWidth: 650, marginTop: 0 }}>
            <div className="fade-up" style={{ animationDelay: "0.15s" }}>
              <h1 style={{ fontFamily: "'Playfair Display', serif", color: "#FFFFFF", fontSize: "clamp(38px, 5vw, 56px)", fontWeight: 600, lineHeight: 1.1, marginBottom: 24, letterSpacing: "0.01em" }}>
                Compassion, Innovation & <span style={{ color: "#FCD34D" }}>Trust</span>
              </h1>
            </div>
            ...
            <div className="fade-up" style={{ animationDelay: "0.45s", display: "flex", gap: 14, flexWrap: "wrap" }}>
              ...
              <a href="/contact-us" className="jpl-sec-btn">Contact Us</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        ref={whoWeAreRef}
        className="reveal-section"
        style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 20px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 44, alignItems: "center" }}
      >
        <div>
          <div className="eyebrow">About JPL Markwin</div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(24px, 5vw, 38px)", fontWeight: 700, color: "#0F172A", lineHeight: 1.2, marginBottom: 20 }}>
  ...
  <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 9, color: "#64748B", letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 3 }}>
    Certified Supplier
      ...
      <section
        ref={valuesRef}
        className="reveal-section"
        style={{ background: "#F8FAFC", padding: "56px 20px" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div className="eyebrow" style={{ justifyContent: "center" }}>What Drives Us</div>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(22px, 5vw, 34px)", fontWeight: 700, color: "#0F172A", marginTop: 4 }}>Our Core Values</h2>
          </div>
      ...
      <section ref={productRef} className="reveal-section product-banner">
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 20px", width: "100%" }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", color: "#FFFFFF", fontSize: "clamp(20px, 5vw, 36px)", fontWeight: 700, lineHeight: 1.2, maxWidth: 520, marginBottom: 12 }}>
    ...
    style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 20px 16px" }}
      >
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(22px, 5vw, 34px)", fontWeight: 700, color: "#0F172A", marginTop: 4 }}>Leadership Team</h2>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
          ...
          <div className="team-card" style={{ padding: 24, border: "1px solid #E2E8F0", borderRadius: 8 }}>
            ...
            <h3 style={{ fontSize: 18, marginBottom: 4 }}>Mr. Markandaiah</h3>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div style={{ overflow: "hidden", flex: 1 }}>
            <div className="cert-ticker-track">
              {[...["ISO 9001:2015", "CDSCO Approved", "GST Registered"], ...["ISO 9001:2015", "CDSCO Approved", "GST Registered"], ...["ISO 9001:2015", "CDSCO Approved", "GST Registered"]].map((cert, i) => (
