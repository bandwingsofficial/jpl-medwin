...
useEffect(() => {
 ...
 async function handleVerify() {
  ...
  try {
    ...
    // ============================================================
    // DETERMINE WHERE USER SHOULD GO AFTER LOGIN
    //
    // Cart checkout:
    // login_redirect_after_auth = "/checkout"
    //
    // Normal login:
    // login_return_url = current page
    //
    // Fallback:
    // "/"
    // ============================================================
    ...
    // ============================================================
    // RETURN USER TO THE ORIGINAL DESTINATION
    //
    // Cart → Login → OTP → Checkout
    // Home → Login → OTP → Home
    // ============================================================
    router.replace(returnUrl);
  } catch (err: any) {
