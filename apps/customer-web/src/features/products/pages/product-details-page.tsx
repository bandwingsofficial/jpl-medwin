...
import { ProductCatalogueSection } from "@/features/products/components/ProductCatalogueSection";
...
>
          ...
          >
            ...
            {product && product.hasCatalogue && product.catalogueFileUrl && (
              <div className="mt-4">
                <ProductCatalogueSection product={product} />
              </div>
            )}
