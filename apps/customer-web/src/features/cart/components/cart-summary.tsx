...
export function CartSummary({ cart }: CartSummaryProps) {
  ...
  const [isCheckoutNavigating, setIsCheckoutNavigating] =
  useState(false);
    ...
    <div className="space-y-4 md:space-y-5">
      ...
      >
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          {Boolean(summary.overweightDeliveryCharge && summary.overweightDeliveryCharge > 0) && (
            <div className="flex items-center justify-between">
              <span className="text-xs md:text-sm text-gray-600">
                Overweight Delivery Charge
              </span>
              <span className="text-sm font-medium text-amber-700">
                +₹{summary.overweightDeliveryCharge?.toLocaleString()}
              </span>
            </div>
          )}
          {/* ====================================================== */}
          ...
          <div className="border-t border-dashed pt-2 md:pt-2">
            <div className="flex items-center justify-between">
        ...
        {summary.savings > 0 && (
  <div className="rounded-xl border border-green-100 bg-green-50 p-1.5 md:p-3">
    <p className="text-xs font-semibold text-green-700 md:text-sm">
      You saved ₹{summary.savings.toLocaleString()}
    </p>

    {couponDiscount > 0 && (
      <p className="mt-1 text-[10px] text-green-600 md:text-xs">
